...
public class FlowAssembler {
    ...
    private AddFlowInput createAddFlow(Match match, String outPort, NodeRef nodeRef,
        ...
        /*
         *  Here we have a hack to fix same match-same priority conflicts.
         */
        Integer addToPriority;
        try {
            addToPriority = Integer.valueOf(outPort);
        } catch (NumberFormatException exc) {
            throw new FlowParserException("Illegal outPort: '" + outPort + "'.");
        }
        //Constant fields
        AddFlowInputBuilder flowBuilder = new AddFlowInputBuilder()
                ...
                .setTableId((short) 0)
                .setPriority(30000 + addToPriority);
